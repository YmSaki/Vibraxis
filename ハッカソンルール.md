...
URL Source: http://openai.devpost.com/rules
...
*   **The Hackathon IS open to:**
    ...
    *   Individuals who are residents of countries and territories that currently support access to OpenAI’s API services listed here and are not excluded below: [Supported countries and territories | OpenAI API](https://platform.openai.com/docs/supported-countries)
...
Entrants may enter by visiting [openai.devpost.com](http://openai.devpost.com/) (“Hackathon Website”) and following the below steps:
...
3.   Obtain access to the required developer tools by completing the following:

    1.   If your free ts are exhausted, Entrants may request $100 in free credits to build their Project for the Hackathon while supplies last and subject to approval. Free credits can only be requested by Entrants registered for the Hackathon. To request credits, complete the form at: **[https://forms.gle/Ncu6iGkaHq1SwUmEA](https://forms.gle/Ncu6iGkaHq1SwUmEA)**by **July 17th at 12pm PT**. Codex credits and credits are not redeemable for cash and must be used by **July 31st****.**

    1.   Optionally, install the Devpost Plugin from the Hackathon Website. Use of the Devpost Plugin is not required to enter or win. See Section 5 (Devpost Plugin) for terms of use.

    2.   Sign up for an[OpenAI account](https://auth.openai.com/create-account) and download Codex.All credits and credits, and all use of OpenAI's services, are subject to OpenAI's Terms of Use ([openai.com/policies/row-terms-of-use](https://openai.com/policies/row-terms-of-use/)), OpenAI's Business Terms governing API and developer use, OpenAI's Service Credit Terms governing credits redeemable for OpenAI services, and OpenAI's Usage Policies ([openai.com/policies/usage-policies](https://openai.com/policies/usage-policies/)).

    3.   NOTE: Any additional charges incurred by the Entrant for the use of OpenAI products or services beyond the provided credits or credits are the responsibility of the Entrant. Entrants are encouraged to monitor their usage so as not to incur additional charges.
...
1.   **Helper, not source of truth.** The Plugin is an AI-assisted tool provided as a convenience. The Plugin is not the official source of any Hackathon information. The Official Rules, the Hackathon Website (openai.devpost.com), and any updates or notices issued by the Sponsor or Administrator govern in all cases. In the event of any conflict or inconsistency between the Plugin and the Official Rules or the Hackathon Website, the Official Rules and the Hackathon Website prevail.

2.   **AI output may be inaccurate.** The Plugin uses generative AI and may produce information that is inaccurate, incomplete, outdated, or otherwise unreliable. This includes, but is not limited to, statements about Hackathon rules, eligibility, deadlines, prizes, submission requirements, and judging criteria. The Entrant is solely responsible for verifying all such information against the Official Rules and the Hackathon Website before relying on it.

3.   **Entrant remains responsible for compliance.** Use of the Plugin does not modify, waive, or replace any requirement set forth in the Official Rules. The Entrant remains solely responsible for ensuring their registration, Submission, and conduct comply with the Official Rules and applicable law, regardless of any guidance, suggestion, output, or content produced by the Plugin.

4.   **No warranty.**The Plugin is provided "as is" and "as available," without warranty of any kind, express or implied. Neither the Sponsor nor the Administrator warrants that the Plugin will be uninterrupted, error-free, or secure, or that any output produced by the Plugin will be accurate, complete, or fit for any particular purpose.

5.   **Limitation of liability.** To the fullest extent permitted by law, the Released Parties (as defined in Section 10) shall not be liable for any damages of any kind arising from or relating to the Entrant's installation or use of the Plugin, including any reliance on Plugin output. Section 13 (Limitations of Liability) applies to use of the Plugin.

6.   **Data, terms, and privacy.**The Plugin may access Hackathon information through Devpost's authenticated services. The Entrant's use of the Plugin is also governed by the Devpost Terms of Service and Privacy Policy referenced in Sections 15 and 16.

7.   **Acknowledgment.** By installing or using the Plugin, the Entrant acknowledges they have read and understood this Section and agrees to its terms as a condition of using the Plugin.
...
1st Place | Apps for Your Life$15,000
...
Pro Account for 1 year 1 All eligible Submissions that enter into the Apps for your life category
2nd Place | Apps for Your Life$10,000

Promotion by OpenAI Developers

Pro Account for 1 year 1 All eligible Submissions that enter into the Apps for your life category
1st Place — Work & Productivity$15,000
...
Pro Account for 1 year 1 All eligible Submissions that enter into the Work & Productivity category
2nd Place | Work & Productivity$10,000

Promotion by OpenAI Developers

Pro Account for 1 year 1 All eligible Submissions that enter into the Work & Productivity category
1st Place | Developer Tools$15,000
...
Pro Account for 1 year 1 All eligible Submissions that enter into the Developer Tools category
2nd Place | Developer Tools$10,000

Promotion by OpenAI Developers

Pro Account for 1 year 1 All eligible Submissions that enter into the Developer Tools category
1st Place | Education$15,000
...
Pro Account for 1 year 1 All eligible Submissions that enter into the Education category
2nd Place | Education$10,000
